...
myApp.controller('paramTable', ['$scope', '$log', function ($scope, $log) {
    ...
    $scope.$watchCollection("[protocol,serverUrl,port]", function () {
        $scope.openWSUrl = $scope.protocol + "://" + $scope.serverUrl + ":" + $scope.port + "/device/connect"
    });
    ...
    $scope.connect1 = function () {
        ...
        let myConnectUrl = $scope.getConnectUrl($scope.dev1id, $scope.dev1lat, $scope.dev1lon);
    ...
    $scope.connect2 = function () {
        ...
        let myConnectUrl = $scope.getConnectUrl($scope.dev2id, $scope.dev2lat, $scope.dev2lon);
    ...
    $scope.connect3 = function () {
        ...
        let myConnectUrl = $scope.getConnectUrl($scope.dev3id, $scope.dev3lat, $scope.dev3lon);
    ...
    $scope.connect4 = function () {
        ...
        let myConnectUrl = $scope.getConnectUrl($scope.dev4id, $scope.dev4lat, $scope.dev4lon);
